...
export default async function EditWorkPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <div className="max-w-3xl"><h1 className="text-3xl font-semibold">编辑作品</h1><WorkForm action={updateWork} work={work} authorId={work.authorId} categories={categories} /><WorkImages workId={work.id} mainImageUrl={assetUrl(work.mainAsset?.storageKey)} previews={work.images} /></div>;
}
