...
export function WorkForm({ action, work, categories, authorId, environments, selectedEnvironmentIds = [], templates = [] }: {
  ...
  return <ProtectedForm action={action} className="mt-8 space-y-5">
    ...
    <FieldOrderEditor order={fieldOrder} onChange={setFieldOrder} />
